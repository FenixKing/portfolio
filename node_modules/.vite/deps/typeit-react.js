...
var createElement2 = (el) => document.createElement(el);
var appendStyleBlock = (styles, id = "") => {
  let styleBlock = createElement2("style");
  styleBlock.id = id;
...
var TypeIt$1 = function(element, options = {}) {
  ...
  let _setUpCursor = () => {
    ...
    let cursor = createElement2("span");
  ...
  let _generateQueue = () => {
    ...
    strings.forEach((string, index) => {
      ...
      let splitItems = _opts.breakLines ? [{ func: () => _type(createElement2("BR")), typeable: true }] : duplicate(
        {
          func: _delete,
          delay: _getPace(1)
        },
